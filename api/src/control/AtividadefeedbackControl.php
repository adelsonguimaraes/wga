...
Class AtividadefeedbackControl {
	//atributos
	protected $con;
	protected $obj;
	protected $objDAO;
	...
	//construtor
	public function __construct(Atividadefeedback $obj=NULL) {
		$this->con = Conexao::getInstance()->getConexao();
		$this->objDAO = new AtividadefeedbackDAO($this->con);
		$this->obj = $obj;
	}
